...
int
h_arm( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	p->alignment_set = !p->alignment_set;
	...
	ui_xcu->sel_func = AXCS_TOP_ALIGNMENT;
	ui_xcu->func_params = p->alignment_set;
