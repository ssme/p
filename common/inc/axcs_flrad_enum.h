...
// 23-Apr-2009 Hopf 18-1
//    added function id AXCS_TUBE_LOAD
//
//---------------------------------------------------------------------------------------------
//
...
typedef  enum  AXCS_FUNC_T_TAG
{
      ...
      AXCS_LABEL_RIGHT          = 551,     // Parameterwert = 0 in UI_XCU / SH_UI_XCU:
                                           // kein Button im Popup am TUI selektiert
      AXCS_LABEL_LEFT           = 552,     // wenn Parameterwerte nicht explizit vorgegeben
      AXCS_DOMINANT_WALL        = 553,     // erhält der kleinste numerische Wert im Popup
      AXCS_DOMINANT_TABLE       = 554,     // den Parameterwert = 1, der nächste den
                                           // Parameterwert = 2 usw.
...
//---------------------------------------------------------------------------------------------
// AXCS_TOMO_MODE tomo mode
//---------------------------------------------------------------------------------------------
typedef  enum  AXCS_TOMO_MODE_T_TAG
{
   AXCS_TOMO_MODE_OFF   = 0x0000,
   AXCS_TOMO_MODE_ON    = 0x0001
}AXCS_TOMO_MODE_T;
...
//---------------------------------------------------------------------------------------------
// AXCS_LABEL_RIGHT label right
//---------------------------------------------------------------------------------------------
typedef  enum AXCS_LABEL_RIGHT_T_TAG
{
   AXCS_RIGHT_NONE         = 0x0000,
   AXCS_RIGHT_UPPERLEFT    = 0x0001,
   AXCS_RIGHT_UPPERRIGHT   = 0x0002,
   AXCS_RIGHT_MIDLEFT      = 0x0003,
   AXCS_RIGHT_MIDRIGHT     = 0x0004,
   AXCS_RIGHT_LOWERLEFT    = 0x0005,   
   AXCS_RIGHT_LOWERRIGHT   = 0x0006
}AXCS_LABEL_RIGHT_T;


//---------------------------------------------------------------------------------------------
// AXCS_LABEL_LEFT label left
//---------------------------------------------------------------------------------------------
typedef  enum AXCS_LABEL_LEFT_T_TAG
{
   AXCS_LEFT_NONE         = 0x0000,
